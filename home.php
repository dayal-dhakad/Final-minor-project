...
<body>
    ...
    <section class="properties container" id="properties">
        ...
        <div class="properties-container container">
            ...
            <div class="box">
                <a href="flatdetails.html"> <img
                        src="https://th.bing.com/th/id/OIP.v92mLIRk-xicFYt-tx62iQHaE8?w=265&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7">
                </a>
                <h3> ₹ 10,000</h3>
                <div class="content">
                    <div class="text">
            ...
            <div class="box">
                <a href="flatdetails.html"> <img
                        src="https://th.bing.com/th/id/OIP.eXxjgjZVYL-iK0huKOOzIgHaE8?w=208&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
                        alt=""> </a>
                <h3> ₹ 15,000</h3>
                <div class="content">
                    <div class="text">
            ...
            <!-- Box 3 -->
            <div class="box">
                <a href="roomdetails.html"> <img
                        src="https://th.bing.com/th/id/OIP.cviwjNdrfYDKEM4VQl5FhAHaEK?w=266&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
                        alt=""> </a>
                <h3> ₹ 8,000</h3>
                <div class="content">
                    <div class="text">
            ...
            <div class="box">
                <a href="pg.html"> <img
                        src="https://th.bing.com/th/id/OIP.UcbzjtAlncXg5_48F0hamwHaFG?w=261&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
                        alt=""> </a>
                <h3> ₹ 5,000</h3>
                <div class="content">
                    <div class="text">
            ...
            <!-- Box 5 -->
            <div class="box">
            <a href="boyshostel.html">  <img src="https://th.bing.com/th/id/OIP.-hiPiSfKxloOWny4d_Wo3gHaFj?w=250&h=188&c=7&r=0&o=5&dpr=1.5&pid=1.7" alt=""> </a>
            <h3> ₹ 6,000</h3>
            <div class="content">
                <div class="text">
                    <h3>Boys Hostel</h3>
            ...
            <!-- Box 6 -->
            <div class="box">
                <a href="girlshostel.html"> <img
                        src="https://th.bing.com/th/id/OIP.biaQVC2v7zDmZmzl19z3AgAAAA?w=148&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7"
                        alt=""> </a>
                <h3> ₹ 7,000</h3>
                <div class="content">
                    <div class="text">
    ...
    <section class="newsletter container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
            <div>
                <textarea style="resize: none; border: none; margin-top: 13px" rows="5" cols="60" name="content"
                    required></textarea>
            </div>
